...
+const receiptX = await setX.wait();
+console.log(receiptX);
+const setY = await game.setY(25);
+const receiptY = await setY.wait();
+console.log(receiptY);
const tx = await game.win();
```

- Update to win.js for Game3 :
